...
Version  : 2.0.5
Release  : 56
URL      : file:///insilications/build/clearlinux/packages/libjpeg-turbo/libjpeg-turbo-2.0.5.zip
Source0  : file:///insilications/build/clearlinux/packages/libjpeg-turbo/libjpeg-turbo-2.0.5.zip
...
unset no_proxy
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596398693
mkdir -p clr-build
pushd clr-build
