...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594251562
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libjpeg-turbo-2.0.5/release/License.rtf %{buildroot}/usr/share/package-licenses/libjpeg-turbo/f0b17b88210d4efef996d99421683315b8ded689
pushd clr-build32
%make_install32
