...
Version  : 9
Release  : 59
URL      : file:///aot/build/clearlinux/packages/libjpeg-turbo/libjpeg-turbo-9.tar.gz
Source0  : file:///aot/build/clearlinux/packages/libjpeg-turbo/libjpeg-turbo-9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620555497
mkdir -p clr-build
pushd clr-build
